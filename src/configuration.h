...
class ConfigurationObject notfinal
{
    ...
    public:
        ...
        /*
         * Removes a key and associated value. Does not propagate to storage,
         * call writeToXML or similar for that.
         *
    ...
    protected:
        ...
        void deleteList(ConfigurationList &list);
...
class Configuration final : public ConfigurationObject
{
    public:
        ...
        /*
         * Set run-time default (or override existing one)
         */
        void setDefault(const std::string &key, VariableData *data);
