    ...
    mDensityList(new NamesModel)
{
    ...
    // TRANSLATORS: settings option
    new SetupItemCheckBox(_("Enable packet/debug log"), "",
        "debugLog", this, "debugLogEvent",
        MainConfig_true);

    // TRANSLATORS: settings option
    new SetupItemTextField(_("Ignore logging packets"),
        // TRANSLATORS: setting description
        _(  "comma separated list of packets to not record in log.\n"
            "example: 3087,3088 to ignore online list updates."),
    ...
    new SetupItemCheckBox(_("Enable server side attack"), "",
        "serverSideAttack", this, "serverSideAttackEvent",
        MainConfig_false);
    ...
    // TRANSLATORS: settings option
    new SetupItemCheckBox(_("Enable packet limiter "
