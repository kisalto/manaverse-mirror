...
class ChatTab notfinal : public Tab
{
    public:
        ...
        /*
         * Send message to server if tab has a server-side endpoint.
         * Does no processing. May log it (if server does not echo).
         */
        virtual void rawSend(const std::string &msg);
    ...
    protected:
        ...
        /**
         * Splits the command string into command and argument parts.
         * if the command was not processed by a chat tab, passes it to
         * input manager.
         *
         * @see handleCommand
         */
