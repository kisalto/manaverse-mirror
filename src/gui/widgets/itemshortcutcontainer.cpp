        ...
        else if (skillDialog != nullptr)
        {
            ...
            if (skill != nullptr)
            {
                ...
                if (skill->cooldown != 0)
                {
                    ...
                    const int cooldownWidth = mBoxWidth - mImageOffsetY;
                    const int barHeight = 10;
                    // Draw cooldown bar on bottom barHeight pixels of image
                    graphics->fillRectangle(
                        Rect(itemX + mImageOffsetX,
                             itemY + mBoxHeight - mImageOffsetY - barHeight,
                             100 * cooldownWidth / skill->cooldown,
                             barHeight));
                }
            }
        }
