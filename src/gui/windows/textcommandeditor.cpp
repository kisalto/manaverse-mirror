    ...
    mEnabledKeyboard(keyboard.isEnabled())
{
    ...
    int row = 0;
#ifdef TMWA_SUPPORT
    place(1, row, mIsMagic);
    place(2, row, mIsOther);
    ++row;
#endif  // TMWA_SUPPORT
    place(0, row, mSymbolLabel).setPadding(3);
    place(1, row, mSymbolTextField, 2, 1).setPadding(3);
    ++row;
    place(0, row, mIconLabel).setPadding(3);
    place(1, row, mIconDropDown, 2, 1).setPadding(3);
    ++row;
    place(0, row, mCommandLabel).setPadding(3);
    place(1, row, mCommandTextField, 2, 1).setPadding(3);
    ++row;
    place(0, row, mCommentLabel).setPadding(3);
    place(1, row, mCommentTextField, 2, 1).setPadding(3);
    ++row;
    place(0, row, mTypeLabel).setPadding(3);
    place(1, row, mTypeDropDown, 2, 1).setPadding(3);
    ++row;
#ifdef TMWA_SUPPORT
    place(0, row, mManaLabel).setPadding(3);
    place(1, row, mManaField, 2, 1).setPadding(3);
    ++row;
    place(0, row, mMagicLvlLabel).setPadding(3);
    place(1, row, mMagicLvlField, 2, 1).setPadding(3);
    ++row;
    place(0, row, mSchoolLabel).setPadding(3);
    place(1, row, mSchoolDropDown, 2, 1).setPadding(3);
    ++row;
    place(0, row, mSchoolLvlLabel).setPadding(3);
    place(1, row, mSchoolLvlField, 2, 1).setPadding(3);
    ++row;
#endif  // TMWA_SUPPORT
    place(0, row, mCancelButton).setPadding(3);
    place(1, row, mDeleteButton).setPadding(3);
    place(2, row, mSaveButton).setPadding(3);
