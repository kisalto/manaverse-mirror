    ...
    mSmallWindow(mainGraphics->getWidth() < 600)
{
    ...
    addButton(N_("CL"),
        ...
        Visible_false);
    // TRANSLATORS: short button name for game info window.
    addButton(N_("GI"),
        8,
        // TRANSLATORS: long button name for game info window.
        _("Game info"), x, h, InputAction::WINDOW_SERVER_INFO,
        Visible_true);
...
WindowMenu::~WindowMenu()
{
    ...
    for (const auto &item : mButtonNames)
        delete item.second;
