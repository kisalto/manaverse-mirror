...
class ActorManager final : public ConfigListener
{
    public:
        ...
        /**
         * Returns FloorItem within given area (or nullptr) that satisfies
         * pickup/ignore lists. Does not prioritise distance.
         *
         * @param x1          bounding box left edge (inclusive)
         * @param y1          bounding box upper edge (inclusive)
         * @param x2          bounding box right edge (inclusive)
         * @param y2          bounding box lower edge (inclusive)
         *
         */
        FloorItem *findItemWithin(const int x1, const int y1,
                                  const int x2, const int y2) const;

        /**
         * Returns nearest FloorItem (or nullptr) that satisfies
         * pickup/ignore lists.
         *
         * @param x           X coordinate of search origin tile
         * @param y           Y coordinate of search origin tile
         * @param maxDist     max distance allowed (in tiles)
         */
        FloorItem *findNearestItem(const int x, const int y,
                                   const int maxDist) const;
