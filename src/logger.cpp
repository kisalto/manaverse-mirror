...
#include <SDL_messagebox.h>
    ...
    #include <android/log.h>
      ...
      #define SPECIALLOG(str) \
          __android_log_print(ANDROID_LOG_INFO, "manaverse", str);
      #define DSPECIALLOG(str) \
          __android_log_print(ANDROID_LOG_VERBOSE, "manaverse", str);
    ...
    #ifdef SPECIAL_LOGGING
      #define SPECIALLOG(str) std::cerr << str;
      #define DSPECIALLOG(str) std::cerr << str;
    #else  // SPECIAL_LOGGING
      #define SPECIALLOG(str) \
          if (mDebugLog) \
              std::cerr << str;
