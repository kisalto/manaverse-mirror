...
/**
 * Create or reinitialise globally accessible in-game windows
 */
static void createGameWindows()
{
...
/**
 * Destroy all the globally accessible in-game windows
 */
static void destroyGameWindows()
{
    if (generalHandler != nullptr)
