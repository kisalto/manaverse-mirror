...
#export CXXFLAGS="${CXXFLAGS} -Wabi="
# not for C++
#export CXXFLAGS="${CXXFLAGS} -Wabsolute-value"
export CXXFLAGS="${CXXFLAGS} -Waddress"
export CXXFLAGS="${CXXFLAGS} -Waddress-of-packed-member"
...
export CXXFLAGS="${CXXFLAGS} -Wattribute-warning"
...
# not for C++
#export CXXFLAGS="${CXXFLAGS} -Wcast-result"
# probably fix in future
...
export CXXFLAGS="${CXXFLAGS} -Wclass-conversion"
...
export CXXFLAGS="${CXXFLAGS} -Wdeprecated-copy"
# may be for future
#export CXXFLAGS="${CXXFLAGS} -Wdeprecated-copy-dtor"
...
export CXXFLAGS="${CXXFLAGS} -Winit-list-lifetime"
# ignoting
...
export CXXFLAGS="${CXXFLAGS} -Wmissing-profile"
...
export CXXFLAGS="${CXXFLAGS} -Wno-alloca-larger-than"
export CXXFLAGS="${CXXFLAGS} -Wno-vla-larger-than"
...
#export CXXFLAGS="${CXXFLAGS} -Woverwrite-recursive"
...
export CXXFLAGS="${CXXFLAGS} -Wpessimizing-move"
...
export CXXFLAGS="${CXXFLAGS} -Wprio-ctor-dtor"
# not for C++
